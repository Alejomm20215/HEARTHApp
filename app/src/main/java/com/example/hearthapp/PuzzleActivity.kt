...
import com.example.hearthapp.databinding.ActivityPuzzleBinding
import com.example.hearthapp.puzzles.PuzzlePiece
import com.example.hearthapp.puzzles.PuzzlesMain
import com.example.hearthapp.puzzles.ScreenGamePuzzle
import com.example.hearthapp.puzzles.TouchListener
...
class PuzzleActivity : AppCompatActivity() {
    ...
    lateinit var binding: ActivityPuzzleBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        window.navigationBarColor = this.resources.getColor(R.color.clear_red_2)
    ...
    private fun getBitmapPositionInsideImageView(imageView: ImageView?): IntArray {
        ...
        val actW = (origW * scaleX).roundToLong()
        val actH = (origH * scaleY).roundToLong()
        ret[2] = actW.toInt()
        ret[3] = actH.toInt()
    ...
    fun checkGameOver()  {
        if (isGameOver) {
            AlertDialog.Builder(this@PuzzleActivity)
                .setTitle("ALLRIGHT, YOU COMPLETED THE PUZZLE .. !!")
                .setIcon(R.drawable.ic_hearth)
                .setMessage("NEW GAME?")
